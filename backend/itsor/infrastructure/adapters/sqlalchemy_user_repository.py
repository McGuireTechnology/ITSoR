...
class SQLAlchemyUserRepository(SQLAlchemyBaseRepository[PlatformUser, UserModel], UserRepository):
    model_class = UserModel

    def __init__(self, db: Session) -> None:
        super().__init__(db, "User")

    def _to_domain(self, record: UserModel) -> PlatformUser:
        return PlatformUser(
            id=record.id,
            name=record.name,
    ...
    def _to_model(self, user: PlatformUser) -> UserModel:
        return UserModel(
            id=user.id,
            name=user.name,
    ...
    def _apply_updates(self, record: UserModel, user: PlatformUser) -> None:
    ...
    def create(self, entity: PlatformUser) -> PlatformUser:
    ...
    def update(self, entity: PlatformUser) -> PlatformUser:
