...
class SQLAlchemyNamespaceRepository(SQLAlchemyBaseRepository[CustomNamespace, NamespaceModel], NamespaceRepository):
    model_class = NamespaceModel

    def __init__(self, db: Session) -> None:
        super().__init__(db, "Namespace")

    def _to_domain(self, record: NamespaceModel) -> CustomNamespace:
    ...
    def _to_model(self, namespace: CustomNamespace) -> NamespaceModel:
    ...
    def _apply_updates(self, record: NamespaceModel, entity: CustomNamespace) -> None:
    ...
    def get_by_name(self, name: str, workspace_id: str) -> CustomNamespace | None:
        record = (
