...
class AuthModelCatalogUseCases:
    ...
    def list_models(self) -> list[str]:
        return sorted(self._auth_model_classes.keys())

    def get_model_details(self, model_name: str) -> dict[str, Any]:
        model_class = self._auth_model_classes.get(model_name)
        if not model_class:
...
AuthRbacUseCases = PlatformRbacUseCases
AuthEndpointPermissionGateway = PlatformEndpointPermissionGateway
AuthGroupMembershipGateway = PlatformGroupMembershipGateway
AuthEndpointPermissionUseCases = PlatformEndpointPermissionUseCases
AuthGroupMembershipUseCases = PlatformGroupMembershipUseCases
PlatformModelCatalogUseCases = AuthModelCatalogUseCases


__all__ = [
    "AuthEndpointPermissionGateway",
    "AuthEndpointPermissionUseCases",
    "AuthGroupMembershipGateway",
