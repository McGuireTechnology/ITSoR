...
from itsor.api.routes.oscal import (
...
app = FastAPI(
	title="ITSoR : OSCAL API",
	description="OSCAL document management sub-application",
	version="0.1.0",
	docs_url=None,
)
...
app.include_router(assessment_plans_router)
app.include_router(assessment_results_router)
app.include_router(poams_router)
app.include_router(component_definitions_router)
app.include_router(system_security_plans_router)
