...
- Contribute updates: [Contributing](contributing.md)

## Role-based entry points

- Operator: [Getting Started](getting-started.md) -> [Environments](environments.md) -> [User Guide](user/README.md)
- Developer: [Getting Started](getting-started.md) -> [Architecture](architecture.md) -> [Developer Guide](developer/README.md)
...
- Admin: [System Definition](system-definition.md) -> [Branch Protection](branch-protection.md) -> [Contributing](contributing.md)
