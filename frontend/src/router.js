...
const routes = [
  ...
  { path: '/system/overview', component: AuthHomePage, meta: { domain: 'auth_home', title: 'Auth Overview', showCommandBar: false } },
  { path: '/system/home', redirect: '/system/overview' },
  { path: '/system/users', component: UsersPage, meta: { domain: 'users', title: 'Users' } },
  { path: '/system/users/me', component: UserMePage, meta: { domain: 'users', title: 'My Account' } },
  { path: '/system/users/:id', component: UserDetailPage, props: true, meta: { domain: 'users', title: 'User Detail' } },
  { path: '/system/users/:id/group-membership', component: UserGroupMembershipPage, props: true, meta: { domain: 'users', title: 'User Group Membership' } },
  { path: '/system/users/:id/user-roles', component: UserRolesPage, props: true, meta: { domain: 'users', title: 'User Roles' } },
  { path: '/system/users/:id/user-tenants', component: UserTenantsPage, props: true, meta: { domain: 'users', title: 'User Tenants' } },
  { path: '/system/groups', component: GroupsPage, meta: { domain: 'groups', title: 'Groups' } },
  { path: '/system/groups/:id', component: GroupDetailPage, props: true, meta: { domain: 'groups', title: 'Group Detail' } },
  { path: '/system/groups/:id/group-memberships', component: GroupMembershipsPage, props: true, meta: { domain: 'groups', title: 'Group Memberships' } },
  { path: '/system/groups/:id/group-roles', component: GroupRolesPage, props: true, meta: { domain: 'groups', title: 'Group Roles' } },
  { path: '/system/tenants', component: TenantsPage, meta: { domain: 'tenants', title: 'Tenants' } },
  { path: '/system/tenants/:id', component: TenantDetailPage, props: true, meta: { domain: 'tenants', title: 'Tenant Detail' } },
  { path: '/system/roles', component: RolesPage, meta: { domain: 'roles', title: 'Roles' } },
  { path: '/system/roles/:id', component: RoleDetailPage, props: true, meta: { domain: 'roles', title: 'Role Detail' } },
  { path: '/system/roles/:id/role-permissions', component: RolePermissionsPage, props: true, meta: { domain: 'roles', title: 'Role Permissions' } },
  { path: '/system/permissions', component: PermissionsPage, meta: { domain: 'permissions', title: 'Permissions' } },
  { path: '/system/permissions/:id', component: PermissionDetailPage, props: true, meta: { domain: 'permissions', title: 'Permission Detail' } },
  ...
  { path: '/users/me', redirect: '/system/users/me' },
  { path: '/users/:id', redirect: (to) => `/system/users/${to.params.id}` },
  { path: '/user/:id', redirect: (to) => `/system/users/${to.params.id}` },
  { path: '/groups', redirect: '/system/groups' },
  { path: '/groups/:id', redirect: (to) => `/system/groups/${to.params.id}` },
  { path: '/tenants', redirect: '/system/tenants' },
  { path: '/tenants/:id', redirect: (to) => `/system/tenants/${to.params.id}` },
  { path: '/roles', redirect: '/system/roles' },
  { path: '/roles/:id', redirect: (to) => `/system/roles/${to.params.id}` },
  { path: '/permissions', redirect: '/system/permissions' },
  { path: '/permissions/:id', redirect: (to) => `/system/permissions/${to.params.id}` },
  { path: '/auth', redirect: '/system/overview' },
  { path: '/auth/home', redirect: '/system/overview' },
  { path: '/auth/:rest(.*)', redirect: (to) => `/system/${String(to.params.rest || '')}` },
